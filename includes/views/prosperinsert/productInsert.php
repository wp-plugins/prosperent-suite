...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<link rel="stylesheet" href="<?php echo $mainURL . 'css/prosperMCE.css?v=1.42232'; ?>">		
		...
		<script data-cfasync="false" type="text/javascript" src="<?php echo $mainURL . 'js/prosperMCE.js?v=1.42322'; ?>"></script>
		<script data-cfasync="false" type="text/javascript" src="<?php echo $result . 'wp-includes/js/tinymce/utils/mctabs.js'; ?>"></script>
		<script type="text/javascript">
			var t;function showValues(){var c=getNewCurrent();clearTimeout(t);var b="",b=jQuery("form").serialize();xmlhttp=new XMLHttpRequest;xmlhttp.onreadystatechange=function(){jQuery("div.preview").html(xmlhttp.responseText).show()};var d=window.location.pathname,c=d.substring(0,d.lastIndexOf("prosperinsert/"))+"preview.php?type="+c+"&";xmlhttp.open("GET",c+b,!0);t=setTimeout(function(){try{xmlhttp.send(),b=""}catch(a){}},500);b||clearTimeout(t)}
			function showAddedValues(){var c=getNewCurrent();clearTimeout(t);var b="",b=jQuery("form").serialize();xmlhttp=new XMLHttpRequest;xmlhttp.onreadystatechange=function(){jQuery("div.added").html(xmlhttp.responseText).show()};var d=window.location.pathname,c=d.substring(0,d.lastIndexOf("prosperinsert/"))+"added.php?type="+c+"&";xmlhttp.open("GET",c+b,!0);t=setTimeout(function(){try{xmlhttp.send(),b=""}catch(a){}},500);b||clearTimeout(t)}
			...
			function sticky_relocate(){var c=jQuery(window).scrollTop(),b=jQuery("#sticky-anchor").offset().top;c>b?jQuery("#stickyHeader").addClass("sticky"):jQuery("#stickyHeader").removeClass("sticky")}jQuery(function(){jQuery(window).scroll(sticky_relocate);sticky_relocate()});
		</script>
    </head>
    <base target="_self" />
			...
			<div class="panel_wrapper">
				<div id="products_panel" class="panel current">
					<fieldset style="font-size:14px;">
						...
						<p><label>Limit:</label><input class="prosperTextSC" tabindex="6" type="text" id="prodlimit" style="width:50px" onKeyUp="showValues();"/><a href="#" class="tooltip"><span>This limit will be used for coupons and non-comparison products, defaults to 1</span></a></p>                    
						<p><label>View:</label>Grid <input tabindex="7" class="viewRadioSC" type="radio" value="grid" id="prodview" checked="checked"/>&nbsp;&nbsp;&nbsp;List <input tabindex="8" type="radio" value="list" id="prodview"/><a href="#" class="tooltip"><span>Checking this will use coupons instead of products</span></a></p>									
						<p><label>Grid Img Size:</label><input tabindex="9" class="prosperTextSC" type="text" id="gridimgsz"  onKeyUp="showValues();"/><a href="#" class="tooltip"><span><strong>Comma Seperate multiple Merchants</strong> If you want to exclude a brand, put an <strong>!</strong> before the brand name.</span></a></p>                    
				...
				<div id="coupons_panel" class="panel">
					<fieldset style="font-size:14px;">
						...
						<p><label>Limit:</label><input class="prosperTextSC" tabindex="3" type="text" id="couplimit" style="width:50px" onKeyUp="showValues();"/><a href="#" class="tooltip"><span>This limit will be used for coupons and non-comparison products, defaults to 1</span></a></p>                    
						<p><label>View:</label>Grid <input tabindex="4" class="viewRadioSC" type="radio" value="grid" id="coupview" checked="checked"/>&nbsp;&nbsp;&nbsp;List <input tabindex="5" type="radio" value="list" id="coupview"/><a href="#" class="tooltip"><span>Checking this will use coupons instead of products</span></a></p>									
				...
				<div id="local_panel" class="panel">		
					<fieldset style="font-size:14px;">
						...
						<p><label>Limit:</label><input class="prosperTextSC" tabindex="6" type="text" id="locallimit" style="width:50px" onKeyUp="showValues();"/><a href="#" class="tooltip"><span>This limit will be used for coupons and non-comparison products, defaults to 1</span></a></p>                    
						<p><label>View:</label>Grid <input tabindex="7" class="viewRadioSC" type="radio" value="grid" id="localview" checked="checked"/>&nbsp;&nbsp;&nbsp;List <input tabindex="8" type="radio" value="list" id="localview"/><a href="#" class="tooltip"><span>Checking this will use coupons instead of products</span></a></p>									
