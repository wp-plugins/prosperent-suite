			...
			<div class="panel_wrapper">
				<div id="products_panel" class="panel current">
					<fieldset style="font-size:14px;">
						...
						<p><label>Price Range:</label><input class="prosper_textinputsmall" style="width:40px;" tabindex="6" type="text" id="pricerangea" name="pricerangea" onKeyUp="showValues();"/>&nbsp;-&nbsp;<input class="prosper_textinputsmall" style="width:40px;" tabindex="7" type="text" id="pricerangeb" name="pricerangeb" onKeyUp="showValues();"/><a href="#" class="tooltip"><span>Enter a price range.</span></a></p>														
						<p><label class="longLabel">Sale Items Only:</label><input tabindex="8" type="checkbox" id="onSale" name="onSale" onClick="showValues();"/><a href="#" class="tooltip"><span>Checking this will only use On Sale Items</span></a></p>                    
						<p><label>Limit:</label><input class="prosperTextSC" tabindex="9" type="text" id="prodlimit" style="width:50px"/><a href="#" class="tooltip"><span>This amount of products to display.</span></a></p>                    
						<p><label>Button Text:</label><input class="prosperTextSC" tabindex="10" type="text" id="prodvisit" name="prodvisit" /><a href="#" class="tooltip"><span>Change the Visit Store button text to anything you'd like. <strong>Defaults to Visit Store</strong></span></a></p>
						<p><label>View:</label>Grid <input tabindex="11" class="viewRadioSC" type="radio" value="grid" name="prodview" id="prodview" checked="checked"/>&nbsp;&nbsp;&nbsp;List <input tabindex="10" type="radio" value="list" name="prodview" id="prodview"/><a href="#" class="tooltip"><span>Choose the view you would like to display products in.</span></a></p>									
						<p><label>Grid Img Size:</label><input tabindex="12" class="prosperTextSC" type="text" id="gridimgsz"/><a href="#" class="tooltip"><span>Image size of grid view products.</span></a></p>                    
						<p><label class="longLabel">Go To Merchant:</label><input tabindex="13" type="checkbox" id="prodgoTo" checked="checked"/><a href="#" class="tooltip"><span>Checking this will link to the merchant's page, skipping the product page for all links.</span></a></p>									
				...
				<div id="coupons_panel" class="panel">
					<fieldset style="font-size:14px;">
						...
						<p><label>View:</label>Grid <input tabindex="5" class="viewRadioSC" type="radio" value="grid" name="coupview" id="coupview" checked="checked"/>&nbsp;&nbsp;&nbsp;List <input type="radio" value="list" name="coupview" id="coupview"/><a href="#" class="tooltip"><span>Choose the view you would like to display products in.</span></a></p>									
				...
				<div id="local_panel" class="panel">		
					<fieldset style="font-size:14px;">
						...
						<p><label>View:</label>Grid <input tabindex="8" class="viewRadioSC" type="radio" value="grid" name="localview" id="localview" checked="checked"/>&nbsp;&nbsp;&nbsp;List <input type="radio" value="list" name="localview" id="localview"/><a href="#" class="tooltip"><span>Choose the view you would like to display products in.</span></a></p>									
				...
				<div id="merchant_panel" class="panel">		
					<fieldset style="font-size:14px;">
						...
						<p><label>Merchant:</label><input class="prosperTextSC" tabindex="1" type="text" id="merchantmerchant" name="merchantm"  onKeyUp="showValues();"/><a href="#" class="tooltip"><span>Enter the merchant name.</span></a></p>														
						<p><label style="width:125px;float:left;">Go to Merchant:</label><input tabindex="2" type="checkbox" id="merchantgoTo" checked="checked"/><a href="#" class="tooltip"><span>Checking this will link to the merchant's page, skipping the product page for all links.</span></a></p>						
