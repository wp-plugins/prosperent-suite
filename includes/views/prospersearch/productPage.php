    ...
    <div id="product" itemscope itemtype="http://data-vocabulary.org/Product">
        <div class="productBlock">
    		<div class="shopCheck productImage" style="text-align:center;">
                <a itemprop="offerURL" href="<?php echo $mainRecord[0]['affiliate_url'] . '&interface=wp&subinterface=prospershop'; ?>" target="<?php echo $target; ?>" rel="nofollow,nolink"><img itemprop="image" src="<?php echo $mainRecord[0]['image_url']; ?>" alt="<?php echo $mainRecord[0]['keyword']; ?>" title="<?php echo $mainRecord[0]['keyword']; ?>"/></a>
    		</div>
            <div class="productContent">
                <div class="shopCheck productTitle"><a href="<?php echo $mainRecord[0]['affiliate_url'] . '&interface=wp&subinterface=prospershop'; ?>" target="<?php echo $target; ?>" rel="nofollow,nolink"><span itemprop="name"><?php echo preg_replace('/\(.+\)/i', '', $mainRecord[0]['keyword']); ?></span></a></div>
                ...
                <div class="productBrandMerchant">
    				<table class="productResults" itemprop="offerDetails" itemscope itemtype="http://data-vocabulary.org/Offer">
    					...
    					foreach ($results as $product)
    					{
    						...
    						echo '<td style="vertical-align:middle;"><div class="shopCheck prosperVisit"><a itemprop="offerURL" href="' . $product['affiliate_url'] . '&interface=wp&subinterface=prospershop' . '" target="' . $target . '" rel="nofollow,nolink"><input type="submit" type="submit" class="prosperVisitSubmit" value="' . $visitButton . '"/></a></div></td>';
    						echo '</tr>';
    					}
    					?>
    				</table>
