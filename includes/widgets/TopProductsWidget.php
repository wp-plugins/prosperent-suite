...
class TopProductsWidget extends WP_Widget
{
    ...
    public function widget( $args, $instance )
    {
		...
		$allData = $modelSearch->trendsApiCall($settings, $fetch, array_map('trim', explode(',', $instance['categories'])), array_map('trim', explode(',', $instance['merchants'])));			
    ...
    public function update( $new_instance, $old_instance )
    {
        ...
        $new_instance = wp_parse_args((array) $new_instance, array( 'title' => '', 'categories' => '', 'merchants' => '', 'numProd' => ''));
    ...
    {
        $instance   = wp_parse_args( (array) $instance, array( 'title' => '', 'categories' => '', 'merchants' => '', 'numProd' => 5) );
