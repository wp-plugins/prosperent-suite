...
<div id="product">
	<div class="productBlock">
		...
		<div class="productImage">
			<a href="<?php echo $productPage . '/store/go/' . urlencode(str_replace(array('http://prosperent.com/', '/'), array('', ',SL,'), $record[0]['affiliate_url'])); ?>" target="<?php echo $target; ?>"><span><img itemprop="image" src="<?php echo $productPage  . '/img/'. urlencode(str_replace(array('http://img1.prosperent.com/images/', '/'), array('', ',SL,'),  $record[0]['image_url'])); ?>" title="<?php echo $record[0]['keyword']; ?>"></span></a>
		</div>
