...
echo '<p class="prosper_settingDesc">' . __( 'The Performance Ads are content based ads. They are intelligent ads that will analyze the page\'s content and display an ad that is relevant. 
