        ...
        foreach ($results as $record)
        {
            ...
            <div class='productBlock'>
                <div class='productImage'>
                    <a href='<?php echo $record['affiliate_url']; ?>' target="_blank"><span><img src='<?php echo $record['image_url']; ?>'  alt='<?php echo $record['keyword']; ?>' title='<?php echo $record['keyword']; ?>'></span></a>
                </div>
                <div class='productContent'>
                    <div class='productTitle'><a href='<?php echo $record['affiliate_url']; ?>' target="_blank"><span><?php echo $record['keyword']; ?></span></a></div>
            ...
            foreach ($coupons as $i => $record)
            {
                ...
                <div class="couponBlock">
                    <div class="couponImage">
                        <?php
                        echo '<a href="' . $record['affiliate_url'] . '" target="_blank"><img src="' . $record['image_url'] . '" style="background: none repeat scroll 0 0 transparent; border: medium none;"></a>';
                        ?>
                    </div>
                    <div class="couponContent">
                        <div class="couponTitle">
                            <?php
                            echo '<a href="' . $record['affiliate_url'] . '" target="_blank">' . $record['keyword'] . '</a>';
                            ?>
                        </div>
                        <?php
