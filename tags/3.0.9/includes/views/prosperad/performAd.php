...
<html>
    <head>
		...
		<link rel="stylesheet" href="<?php echo $mainURL . 'css/prosperMCE.css?v=12'; ?>">
		...
		<script data-cfasync="false" type="text/javascript" src="<?php echo $mainURL . 'js/prosperMCE.js'; ?>"></script>
