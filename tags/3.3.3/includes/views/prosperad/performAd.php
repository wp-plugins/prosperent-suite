	...
	<body onload="setFocus()">
		<form action="/" method="get" id="prosperSCForm">
			<fieldset style="font-size:14px">
				...
				<p><label>Use Tags:</label><input tabindex="3" type="checkbox" id="useTags" checked="checked"/><a href="#" class="tooltip"><span>Adds your page/post tags to the topic list. You can remove common tags under the ProsperAd settings.</span></a></p>
				<p><label>Use Title:</label><input tabindex="4" type="checkbox" id="useTitle" checked="checked"/><a href="#" class="tooltip"><span>Adds your page/post title to the topic list. You can remove common tags under the ProsperAd settings</span></a></p>
				<p><label>Additional:</label><input class="prosperTextSC" tabindex="5" type="text" id="topic"/><a href="#" class="tooltip"><span>Comma seperated list. Max 3 (including title and tags if used). Topics to use for your page's ad.</span></a></p>
