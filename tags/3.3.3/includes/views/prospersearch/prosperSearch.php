			...
			<fieldset style="font-size:14px">
				...
				<p>
					...
					<span style="font-size:12px">
						<input tabindex="1" type="radio" id="searchFor" name="searchFor" value="prod" checked="checked" /> <strong>Products</strong>
				...
				<p><label class="longLabel">Search Bar Text:</label><input class="prosperTextSC" tabindex="2" type="text" id="sBarText" name="sBarText" "/><a href="#" class="tooltip"><span><strong>Enter the text bar place holder text</strong></span></a></p>
				...
				<p>
					<label class="shortLabel">Width:</label><input class="prosperShortTextSC" tabindex="4" type="text" name="w" id="width" />
					<span style="font-size:12px">
						<input tabindex="5" type="radio" id="widthStyle" name="widthStyle" value="%" /><strong>%</strong>
				...
				<p><label class="shortLabel">CSS:</label><input class="prosperTextSC" tabindex="6" type="text" id="css" name="css" "/><a href="#" class="tooltip"><span><strong>Use CSS standards</strong></span></a></p>
				<input tabindex="7" type="submit" value="Submit" class="button-primary" id="prosperMCE_submit" onClick="javascript:shortCode.insert(shortCode.local_ed)"/>
			</fieldset>
		</form>
	</body>
</html>