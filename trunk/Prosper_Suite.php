...
if (!class_exists('Prosperent_Suite'))
{
    ...
    class Prosperent_Suite extends Prosperent_Admin
    {
		...
		{
			add_rewrite_rule('local/([^/]*)/cid/([^/]*)/?', 'index.php?pagename=products&keyword=$matches[1]&cid&cid=$matches[2]', 'top');
			add_rewrite_rule('travel/([^/]*)/cid/([^/]*)/?', 'index.php?pagename=products&keyword=$matches[1]&cid&cid=$matches[2]', 'top');
			add_rewrite_rule('coupon/([^/]*)/cid/([^/]*)/?', 'index.php?pagename=products&keyword=$matches[1]&cid&cid=$matches[2]', 'top');
			add_rewrite_rule('product/([^/]*)/cid/([^/]*)/?', 'index.php?pagename=products&keyword=$matches[1]&cid&cid=$matches[2]', 'top');
			add_rewrite_rule('celebrity/([^/]*)/cid/([^/]*)/?', 'index.php?pagename=products&keyword=$matches[1]&cid&cid=$matches[2]', 'top');
			add_rewrite_rule('store/go/([^/]*)/?', 'index.php?pagename=products&go&storeUrl=$matches[1]', 'top');
			add_rewrite_rule('img/([^/]*)/?', 'index.php?pagename=products&prosperImg=$matches[1]', 'top');
			add_rewrite_rule('products/(.*)', 'index.php?pagename=products&queryParams=$matches[1]', 'top');
		}
