...
echo '<h2>' . __( 'Image URL Masking', 'prosperent-suite' ) . '</h2>';
echo $prosper_admin->geoCheckbox( 'Image_Masking', __( 'Image URL Masking', 'prosperent-suite' ), '', '',  '<a href="#" class="tooltip"><img border="0" src="' . PROSPER_URL . '/img/help.png"><span>Masks the image urls to, they will now match your website\'s URL. Only advise the use of the if you are <strong>NOT</strong> on shared hosting, otherwise your images may load slowly.</span></a>' );
