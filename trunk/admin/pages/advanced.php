...
echo $prosper_admin->textinput( 'Base_URL', __( 'Base Url', 'prosperent-suite' ), '', '<a href="#" class="tooltip"><img border="0" src="' . PROSPER_URL . '/img/help.png"><span>If you have a different URL from "<strong>your-blog.com/product</strong>" that you want the search query to go to.</span></a>' );
echo '<p class="descb">' . __( "", 'prosperent-suite' ) . '</p>';
