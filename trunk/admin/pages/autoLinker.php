...
echo '<p class="prosper_descb">' . __( 'Define text and the query in the field above. Follow this format:<br>
...
echo '<h2 class="prosper_h2">' . __( 'Auto-Linker Matching Settings', 'prosperent-suite' ) . '</h2>';								
