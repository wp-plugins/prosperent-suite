    ...
    <body onload="setFocus();">
        <form action="/" method="get" id="prosperSCForm">
			<fieldset style="font-size:14px;">
				...
				<p><label>Use Tags:</label><input tabindex="4" type="checkbox" id="useTags" checked="checked"/><a href="#" class="tooltip"><span>Adds your page/post tags to the topic list. You can remove common tags under the Performance Ad settings.</span></a></p>
				<p><label>Use Title:</label><input tabindex="5" type="checkbox" id="useTitle" checked="checked"/><a href="#" class="tooltip"><span>Adds your page/post title to the topic list. You can remove common tags under the Performance Ad settings</span></a></p>
