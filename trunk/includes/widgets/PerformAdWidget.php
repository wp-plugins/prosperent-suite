...
class PerformAdWidget extends WP_Widget
{
    ...
    public function form( $instance )
    {
		...
		<p><label for="<?php echo $this->get_field_id('width'); ?>"><?php _e('Width:'); ?></label><a href="#" class="prosper_tooltip_widget"><img border="0" src="<?php echo PROSPER_IMG . '/help.png'; ?>"><span>Using <strong>auto</strong> will scale the ad to fit.<br>Minimum = 77</span></a>
		...
		<p><label for="<?php echo $this->get_field_id('height'); ?>"><?php _e('Height:'); ?></label><a href="#" class="prosper_tooltip_widget"><img border="0" src="<?php echo PROSPER_IMG . '/help.png'; ?>"><span>Minimum = 54</span></a>
		...
		<p><label for="<?php echo $this->get_field_id('topic'); ?>"><?php _e('Topic:'); ?></label><a href="#" class="prosper_tooltip_widget"><img border="0" src="<?php echo PROSPER_IMG . '/help.png'; ?>"><span><strong>Seperate by commas. Max 3 (including title and tags if used).</strong> A topic is either a generic term that summarizes your site or a specific product.</span></a>
		...
		<p><label for="<?php echo $this->get_field_id('usetags'); ?>"><?php _e('Use Tags as Topic:'); ?></label><a href="#" class="prosper_tooltip_widget"><img border="0" src="<?php echo PROSPER_IMG . '/help.png'; ?>"><span>Will add post tags to the fallback list if there are any.</span></a>
		...
		<p><label for="<?php echo $this->get_field_id('usetitle'); ?>"><?php _e('Use Title as Topic:'); ?></label><a href="#" class="prosper_tooltip_widget"><img border="0" src="<?php echo PROSPER_IMG . '/help.png'; ?>"><span>Will add page title to the fallback list.</span></a>
