...
class ProductInsertWidget extends WP_Widget
{
    ...
    public function widget( $args, $instance )
    {
		...
		$allData = $modelSearch->singleCurlCall($curlUrls);
    ...
    public function update( $new_instance, $old_instance )
    {
        ...
        $new_instance = wp_parse_args((array) $new_instance, array( 'title' => '', 'query' => '', 'categories' => '', 'merchants' => '', 'brands' => '', 'imageSize' => 125, 'numProd' => 5, 'goToMerch' => '', 'useTitle' => '', 'coupons' => ''));
    ...
    {
        $instance   = wp_parse_args( (array) $instance, array( 'title' => '', 'query' => '', 'categories' => '', 'merchants' => '', 'brands' => '', 'imageSize' => 125, 'numProd' => 5, 'goToMerch' => '', 'useTitle' => '', 'coupons' => '') );
