		...
		?>
			...
			<div class="listBlock">
				<div class="prodContent">
					<div class="prodImage">
						<a href="<?php echo $productPage . '/coupon/' . urlencode(str_replace('/', ',SL,', $merchCoup['keyword'])) . '/cid/' . $merchCoup['couponId']; ?>"><img src="<?php echo ($options['Image_Masking'] ? $productPage  . '/img/'. urlencode(str_replace(array('http://img1.prosperent.com/images/', '/'), array('', ',SL,'), $merchCoup['image_url'])) : $merchCoup['image_url']); ?>" title="<?php echo $merchCoup['keyword']; ?>"></a>
					</div>
					<div class="prodTitle">
